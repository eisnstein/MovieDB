...
public static class AccountsEndpoint
{
    ...
    public static async Task<IResult> VerifyEmail(IAccountService accountService, VerifyEmailRequest model)
    {
    ...
    public static async Task<IResult> ValidateResetToken(IAccountService accountService, ValidateResetTokenRequest model)
    {
        await accountService.ValidateResetTokenAsync(model.Token);
        return Results.Ok(new { message = "Token is valid"});
    }

    public static async Task<IResult> ResetPassword(IAccountService accountService, ResetPasswordRequest model)
    {

...
<template>
  <div class="mt-6 container max-w-md mx-auto flex bg-white shadow-md rounded p-6 pt-6">
    <form class="w-full" @submit.prevent="onSubmit">
      <div>
        <input type="text" v-model="title" id="title" placeholder="Title of the theater" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
      </div>
      <div class="mt-4">

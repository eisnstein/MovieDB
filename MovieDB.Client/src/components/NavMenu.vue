          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline">
              <router-link to="/movies" active-class="text-white bg-gray-700"
                           class="px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none">
                Movies
              </router-link>
              <router-link to="/concerts" active-class="text-white bg-gray-700"
                           class="ml-4 px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none">
                Concerts
              </router-link>

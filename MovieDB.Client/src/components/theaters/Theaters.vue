      ...
      <div v-else>
        <div class="py-2 flex items-center">
            <input
                ...
                type="text"
                v-model="searchValue" />
            <router-link to="/theaters/new" class="ml-2 whitespace-nowrap text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded text-sm px-5 py-2.5 text-center inline-flex items-center">Add Theater</router-link>
        </div>
